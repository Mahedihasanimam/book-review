    ...
    <div>
      <div className="card lg:flex-row flex-col card-side bg-base-100 shadow-xl  border-2 border-gray-200 mb-4">
        ...
        <div>
            <strong>Tag </strong>
        {
          tags.map((tag,index)=><a key={index} className="py-1 bg-opacity-50 bg-green-100 hover:bg-green-100 text-green-400 rounded-full font-bold lg:px-4 px-1 lg:ml-4 ml-1"># {tag}</a>)
        }
